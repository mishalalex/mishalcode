/*
  ...
  - You are about to drop the `ProblemsSolvedByUser` table. If the table is not empty, all the data it contains will be lost.

*/
-- DropForeignKey
ALTER TABLE "ProblemsSolvedByUser" DROP CONSTRAINT "ProblemsSolvedByUser_problemId_fkey";

-- DropForeignKey
ALTER TABLE "ProblemsSolvedByUser" DROP CONSTRAINT "ProblemsSolvedByUser_userId_fkey";

-- DropTable
DROP TABLE "ProblemsSolvedByUser";
